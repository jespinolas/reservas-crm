...
export function buildAgentSystemPrompt(input: {
  ...
  return [
    ...
    [
      ...
      '- {"action":"booking_find_options","serviceId":"<id del servicio>","rangeStart":"<ISO>","rangeEnd":"<ISO>","partySize":4} — pedirle al CRM opciones reales de reserva cuando el cliente da servicio/fecha/rango/personas suficientes.',
      '- {"action":"booking_confirm_selected_option","customerConfirmed":true} — crear un hold solo cuando el cliente confirma explícitamente la opción que el CRM ya mostró.',
      "Reglas duras:",
      "- Si el cliente pide hablar con una persona/humano/asesor → handoff.",
      "- Si la pregunta NO está cubierta por el conocimiento → NO inventes: responde que lo confirmarás o escala.",
      "- Para reservas, NO inventes disponibilidad, precios, señas ni confirmaciones. Usa booking_find_options y booking_confirm_selected_option.",
      "- Nunca digas que una reserva está confirmada por pago; el negocio debe aprobar el pago manualmente.",
