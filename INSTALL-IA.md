# INSTALL-IA.md — Instalación de reservas-crm guiada por IA
...
**Repositorio**: `https://github.com/jespinolas/reservas-crm` (público, rama `main`,
...
> ✅ reservas-crm quedó instalado en `https://<dominio>`.
>
